...
import colmar from "./colmar.JPG"
import jammming from "./jammming.JPG"
import exercise from "./exercise-tracking.png"
import how from "./how-old.JPG"
  ...
  return (
    <div className = "list">
        ...
        <div className = "item">
            ...
            <a href = "https://github.com/Jiroge/Tea-Cozy-Web" target = "_blank"><img src={giticon}/></a>
        </div>
        <div className="item">
            <img src={colmar}/>
            ...
            <p><span>HTML</span><span>CSS</span></p>
            {/* <a href = "#" target = "_blank"><img src="src/components/project/link.png"/></a> */}
            <a href = "https://github.com/Jiroge/Colmar-Web" target = "_blank"><img src={giticon}/></a>
        </div>
        <div className="item">
            <img src={jammming}/>
            <h3>Jammming</h3>
            ...
            {/* <a href = "#" target = "_blank"><img src="src/components/project/link.png"/></a> */}
            <a href = "https://github.com/Jiroge/Jammming-Spotify-Class-Component" target = "_blank"><img src=src={giticon}/></a>
        </div>
        <div className="item">
            <img src={exercise}/>
            ...
            <p><span>HTML</span><span>CSS</span>
            <span>JAVASCRIPT</span><span>REACT</span></p>
            <a href = "https://fitfriends.vercel.app/" target = "_blank"><img src={link}/></a>
            <a href = "https://github.com/Jiroge/FitFriends-Frontend" target = "_blank"><img src={giticon}/></a>
        </div>
        <div className="item">
            <img src={how}/>
            ...
            {/* <a href = "#" target = "_blank"><img src="src/components/project/link.png"/></a> */}
            <a href = "#" target = "_blank"><img src={giticon}/></a>
        </div>
    </div>
  )
}
